...
const EXPAND_COLORS = [
  ...
  { bg: 'bg-green-500/8', text: 'text-green-600 dark:text-green-400', btnText: 'text-green-400', border: 'border-green-400/20', badge: 'bg-green-500/12 text-green-600 dark:text-green-400' },
  { bg: 'bg-orange-500/8', text: 'text-orange-600 dark:text-orange-400', btnText: 'text-orange-400', border: 'border-orange-400/20', badge: 'bg-orange-500/12 text-orange-600 dark:text-orange-400' },
  { bg: 'bg-purple-500/8', text: 'text-purple-500 dark:text-purple-400', btnText: 'text-purple-400', border: 'border-purple-400/20', badge: 'bg-purple-500/12 text-purple-500 dark:text-purple-400' },
] as const;
...
export function ContentPanel({
  ...
  return (
    <div ref={containerRef} key={activeNode.id} className="h-full flex flex-col overflow-hidden animate-content-in">
      ...
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
        ...
        {/* Action bar */}
        <div className="shrink-0 px-6 py-2 border-t border-border bg-card/60 flex items-center gap-2">
          {divergeState.isRunning ? (
